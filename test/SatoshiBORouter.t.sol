...
contract SatoshiBORouterTest is Test, DeployBase, TroveBase, TestConfig, Events {
    ...
    function setUp() public override {
        ...
        (sortedTrovesBeaconProxy, troveManagerBeaconProxy) = _deploySetupAndInstance(
            DEPLOYER, OWNER, ORACLE_MOCK_DECIMALS, ORACLE_MOCK_VERSION, roundData, weth, deploymentParams
        );
    ...
    function testAddCollByRouter() public {
        ...
        satoshiBORouter.addColl{value: vars.addCollAmt}(
            troveManagerBeaconProxy, user, vars.addCollAmt, vars.upperHint, vars.lowerHint
        );
    ...
    function testwithdrawCollByRouter() public {
        ...
        satoshiBORouter.withdrawColl(
            troveManagerBeaconProxy, user, vars.withdrawCollAmt, vars.upperHint, vars.lowerHint
        );
    ...
    function testRepayDebtByRouter() public {
        ...
        // tx execution
        satoshiBORouter.repayDebt(troveManagerBeaconProxy, user, vars.repayDebtAmt, vars.upperHint, vars.lowerHint);
