...
contract RedeemCollDecimals8Test is Test, DeployBase, TroveBase, TestConfig, Events {
    ...
    function test_getRedemptionHints() public {
        _openTrove(user1, 1e8, 13333e18);
        _openTrove(user2, 1e8, 13793e18);
    ...
    function test_PartialRedeem() public {
        ...
        _openTrove(user1, 1000000e8, 133330e18);
        _openTrove(user2, 1e8, 13793e18);
        _openTrove(user3, 1e8, 20000e18);
        _openTrove(user4, 1e8, 30000e18);
    ...
    function test_RedeemOnlyOneTrove() public {
        ...
        _openTrove(user1, 1000000e8, 1000e18);
        _openTrove(user2, 1e8, 50e18);
    ...
    function test_redeem() public {
        ...
        _openTrove(user4, 100e8, 30000e18);
        ...
        assertEq(collateral.balanceOf(user3), surplusBlance);
        assertEq(collateral.balanceOf(user3), expectedColl);
    }
}
