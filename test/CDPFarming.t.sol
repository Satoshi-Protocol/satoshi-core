...
//         // transfer funds back
//         vaultManagerProxy.transferCollToTroveManager(address(troveManagerBeaconProxy), 0.7e18);
...
//         vm.expectRevert("Only owner");
//         vaultManagerProxy.transferCollToTroveManager(address(troveManagerBeaconProxy), 1e18);
//     }
